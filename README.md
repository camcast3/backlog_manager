...
│   │   │   ├── vibeQuestions.js    # structured vibe question bank
│   │   │   └── search.js          # HLTB + RAWG game search
│   │   ├── services/
│   │   │   ├── gamificationService.js  # XP, levels, achievements
│   │   │   ├── vibeService.js          # vibe analysis, staleness checks
│   │   │   ├── vibeQuestionService.js  # structured vibe questions
│   │   │   ├── hltbService.js          # HLTB cache TTL + staleness
│   │   │   └── gameSearchService.js    # HLTB search + RAWG covers
│   │   └── server.js
│   ├── .env.example
│   └── package.json
